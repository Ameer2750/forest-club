...
<div>
    ...
    <!-- carousel end -->
    <div class="flex flex-row justify-between items-center mx-[4rem] my-14 gap-5">
...
<div>
    ...
    <div id="indicators-carousel" class="relative w-full py-10 px-4" data-carousel="static">
        <!-- Carousel wrapper -->
        <div class="relative h-[450px] overflow-hidden">
            <!-- Item 1 -->
...
<div class="max-w-sm rounded overflow-hidden shadow-lg">
    <div class="relative">
        <img class="w-full" src="{{asset('images/card-bg.jpg')}}" alt="...">
